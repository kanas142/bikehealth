...
<head>
    ...
    <title>Bike Health - <?php echo $titulo; ?></title>
    <link rel="icon" href="/build/img/logo.ico" type="image/x-icon">
    ...
    <!-- Agrega las bibliotecas de jQuery y jQuery UI -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <!-- Agrega la biblioteca de Bing Maps -->
